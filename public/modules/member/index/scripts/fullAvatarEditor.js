function fullAvatarEditor() {
	...
	var file			= '../../public/modules/member/index/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= '../../public/modules/member/index/expressInstall.swf';			//expressInstall.swf的路径
	var	width			= 790;							//flash文件的宽度
